...
CATALOG = [
    ...
    {
        "id": "tee-001",
        "name": "Fortune Special Tee (Cotton)",
...
class GameMasterAgent(Agent):
    def __init__(self):
        ...
        instructions = """
        You are 'Shamu Kaka', the friendly shopkeeper and voice assistant for the Fortune shop.
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("\n" + "🛍️" * 6)
    logger.info("🚀 STARTING VOICE E-COMMERCE AGENT the Fortune shop — Shamu Kaka")
